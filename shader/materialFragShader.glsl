...
//        }
    ...
    float theta = dot(lightDir, normalize(-light.direction)); // negate light.direction because we want the vectors to point towards the light source instead from it
